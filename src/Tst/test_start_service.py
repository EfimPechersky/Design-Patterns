...
class TestStartService:
    ...
    @pytest.mark.parametrize("ind, range",[
        (0,range_model.create_gramm()),
        (1,range_model.create_kilogramm()),
        (2,range_model.create_num()),
        (3,range_model.create_liter()),
        (4,range_model.create_milliliter())
    ])
    ...
    @pytest.mark.parametrize("ind, group",[
        (0,nomenclature_group_model.create_animal_products()),
        (3,nomenclature_group_model.create_grain_products()),
        (2,nomenclature_group_model.create_milk_products()),
        (4,nomenclature_group_model.create_seasoning_products()),
        (1, nomenclature_group_model.create_sugar_products()),
        (5, nomenclature_group_model.create_addition_products())
    ])
    ...
    @pytest.mark.parametrize("ind, nomenclature",[
        (0,nomenclature_model.create_butter()),
        (1,nomenclature_model.create_eggs()),
        (2,nomenclature_model.create_flour()),
        (4,nomenclature_model.create_vanilla()),
        (3,nomenclature_model.create_sugar()),
        (5,nomenclature_model.create_cacao()),
        (6,nomenclature_model.create_soda()),
        (7,nomenclature_model.create_sour_cream())
    ])
    ...
    @pytest.mark.parametrize("ind, receipt",[
        (0,receipt_model.create_waffles_receipt())
    ])
